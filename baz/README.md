# The really cool Baz API

[![Go Reference](https://pkg.go.dev/badge/github.com/codyoss/bar/baz.svg)](https://pkg.go.dev/github.com/codyoss/bar/baz)

Go Client Library for The really cool Baz API.

## Install

```bash
go get github.com/codyoss/bar/baz
```
